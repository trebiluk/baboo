...
export function DockRail() {
  ...
  const busy = teachingOpen || accessOpen || helpOpen || customizeOpen;
  const expanded = panelsPinned || hover || focus || busy;
  ...
  return (
    <nav
      className={`dock-rail ${expanded ? 'is-open' : 'is-min'}`}
    ...
    >
      {!expanded && (
        <button
          ...
          title="Show Teach, Access, Help, and Settings"
          aria-label="Show Teach, Access, Help, and Settings"
        >
