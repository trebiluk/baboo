...
export const STR: Record<string, Gloss> = {
  ...
  'chrome.save': g('Save file', {
    es: 'Guardar archivo', cu: 'Guardar archivo', uk: 'Зберегти файл', ru: 'Сохранить файл', ti: 'ዓቅብ', fa: 'ذخیره فایل',
  }),
  ...
  /* Tip pack — CURRICULUM-TIP-PACK-EN-ES.md. EN and ES are the locked strings;
     the other five classroom languages follow the same one-step shape. Roof and
     shop words (gable, hip, grass, alias) stay English everywhere. */
  'tip.welcome.title': g('Sketch the house first', {
    es: 'Primero dibuja la casa',
    cu: 'Primero dibuja la casa',
    uk: 'Спочатку намалюй будинок',
    ru: 'Сначала нарисуй дом',
    ti: 'መጀመርታ ነታ ገዛ ስኣል',
    fa: 'اول خانه را بکش',
  }),
  'tip.welcome.body': g('Pick a house style — or choose Wall and click twice.', {
    es: 'Elige un estilo de casa — o elige Muro y haz dos clics.',
    cu: 'Elige un estilo de casa — o elige Pared y toca dos veces.',
    uk: 'Вибери стиль будинку — або вибери Wall і клікни двічі.',
    ru: 'Выбери стиль дома — или выбери Wall и кликни дважды.',
    ti: 'ቅዲ ገዛ ምረጽ — ወይ Wall ምረጽን ክልተ ጊዜ ጠውቕን።',
    fa: 'یک سبک خانه انتخاب کن — یا Wall را بزن و دو بار کلیک کن.',
  }),
  'tip.wall.title': g('Draw a wall', {
    es: 'Dibuja un muro',
    cu: 'Dibuja una pared',
    uk: 'Намалюй стіну',
    ru: 'Нарисуй стену',
  ...
  'tip.wall.body': g('Click where it starts. Click where it ends.', {
    es: 'Clic donde empieza. Clic donde termina.',
    cu: 'Toca donde empieza. Toca donde termina.',
    uk: 'Клікни, де починається. Клікни, де закінчується.',
    ru: 'Кликни, где начинается. Кликни, где кончается.',
    ti: 'ኣብቲ ዝጅምረሉ ጠውቕ። ኣብቲ ዝውድኣሉ ጠውቕ።',
    fa: 'جایی که شروع می‌شود کلیک کن. جایی که تمام می‌شود کلیک کن.',
  }),
  'tip.door.title': g('Add a door', {
    es: 'Añade una puerta',
    cu: 'Pon una puerta',
    uk: 'Додай двері',
    ru: 'Добавь дверь',
  ...
  'tip.door.body': g('Click close to a wall.', {
    es: 'Haz clic cerca de un muro.',
    cu: 'Toca cerca de una pared.',
    uk: 'Клікни близько до стіни.',
    ru: 'Кликни рядом со стеной.',
    ti: 'ኣብ ጥቓ መንደቕ ጠውቕ።',
    fa: 'نزدیک یک دیوار کلیک کن.',
  }),
  'tip.save.title': g('Save your plan', {
    es: 'Guarda tu plano',
    cu: 'Guarda tu plano',
    uk: 'Збережи свій план',
    ru: 'Сохрани свой план',
    ti: 'ትልምኻ ዓቅብ',
    fa: 'نقشه‌ات را ذخیره کن',
  }),
  'tip.save.body': g('Tap Save file when you want a copy for class.', {
    es: 'Toca Guardar archivo para una copia de clase.',
    cu: 'Toca Guardar archivo para una copia de clase.',
    uk: 'Натисни Зберегти файл, щоб мати копію для класу.',
    ru: 'Нажми Сохранить файл, чтобы была копия для класса.',
    ti: 'ንክፍሊ ቅዳሕ እንተ ደሊኻ Save file ጠውቕ።',
    fa: 'برای یک کپی برای کلاس روی ذخیره فایل بزن.',
  }),
  'tip.roof.title': g('Name your roof', {
    es: 'Nombra el techo',
    cu: 'Nombra el techo',
    uk: 'Назви свій дах',
    ru: 'Назови свою крышу',
    ti: 'ንናሕስኻ ስም ሃቦ',
    fa: 'به سقفت نام بده',
  }),
  'tip.roof.body': g('The computer drew it. You still say the name (gable, hip, grass…).', {
    es: 'La computadora lo dibujó. Tú dices el nombre (gable, hip, grass…).',
    cu: 'La computadora lo dibujó. Tú dices el nombre (gable, hip, grass…).',
    uk: 'Комп’ютер намалював. Назву кажеш ти (gable, hip, grass…).',
    ru: 'Компьютер нарисовал. Название говоришь ты (gable, hip, grass…).',
    ti: 'እታ ኮምፒተር ሰኣለታ። ስሙ ግን ንስኻ ትብል (gable, hip, grass…)።',
    fa: 'کامپیوتر آن را کشید. اسمش را تو می‌گویی (gable، hip، grass…).',
  }),
  'tip.3d.title': g('3D is look-only', {
    es: '3D solo se mira',
    cu: '3D solo se mira',
    uk: '3D — тільки дивитися',
    ru: '3D — только смотреть',
    ti: '3D ንምርኣይ ጥራይ',
    fa: 'سه‌بعدی فقط تماشاست',
  }),
  'tip.3d.body': g('Look here. Edit walls back in 2D.', {
    es: 'Mira aquí. Edita los muros en 2D.',
    cu: 'Mira aquí. Edita las paredes en 2D.',
    uk: 'Дивись тут. Стіни редагуй у 2D.',
    ru: 'Смотри здесь. Стены правь в 2D.',
    ti: 'ኣብዚ ተመልከት። መናድቕ ኣብ 2D ኣስተኻኽል።',
    fa: 'اینجا نگاه کن. دیوارها را در 2D ویرایش کن.',
  }),
  'tip.teach.title': g('Teaching help', {
    es: 'Ayuda de clase',
    cu: 'Ayuda de clase',
    uk: 'Допомога для уроку',
    ru: 'Помощь для урока',
    ti: 'ሓገዝ ትምህርቲ',
    fa: 'کمک کلاسی',
  }),
  'tip.teach.body': g('Short steps for class. Tap once to open or close.', {
    es: 'Pasos cortos. Toca una vez para abrir o cerrar.',
    cu: 'Pasos cortos. Toca una vez para abrir o cerrar.',
    uk: 'Короткі кроки. Натисни раз, щоб відкрити чи закрити.',
    ru: 'Короткие шаги. Нажми раз, чтобы открыть или закрыть.',
    ti: 'ንክፍሊ ሓጸርቲ ስጉምትታት። ንምኽፋት ወይ ንምዕጻው ሓንሳብ ጠውቕ።',
    fa: 'گام‌های کوتاه برای کلاس. یک بار بزن تا باز یا بسته شود.',
  }),
  'tip.class-card.title': g('Class card', {
    es: 'Tarjeta de clase',
    cu: 'Tarjeta de clase',
    uk: 'Класна картка',
    ru: 'Классная карточка',
    ti: 'ካርድ ክፍሊ',
    fa: 'کارت کلاسی',
  }),
  'tip.class-card.body': g('For the hallway board. Use your alias — no last name.', {
    es: 'Para el pasillo. Usa tu alias — sin apellido.',
    cu: 'Para el pasillo. Usa tu alias — sin apellido.',
    uk: 'Для дошки в коридорі. Пиши свій alias — без прізвища.',
    ru: 'Для доски в коридоре. Пиши свой alias — без фамилии.',
    ti: 'ነቲ ኣብ መተሓላለፊ ዘሎ ሰሌዳ። alias ተጠቐም — ስም ኣቦ የብሉን።',
    fa: 'برای تابلوی راهرو. از alias خودت استفاده کن — بدون نام خانوادگی.',
  }),

  'tip.gotIt': g('Got it', {
    es: 'Entendido', cu: 'Entendido', uk: 'Зрозуміло', ru: 'Понятно', ti: 'ተረዲኡኒ', fa: 'فهمیدم',
  }),
  'tip.next': g('Next tip', {
    es: 'Siguiente consejo', cu: 'Siguiente consejo', uk: 'Наступна підказка', ru: 'Следующая подсказка', ti: 'ዝቕጽል ምኽሪ', fa: 'راهنمای بعدی',
  }),
  'tip.show': g('Show tips', {
    es: 'Mostrar tips', cu: 'Mostrar tips', uk: 'Показувати підказки', ru: 'Показывать подсказки', ti: 'ምኽርታት ኣርኢ', fa: 'نمایش راهنما',
  }),
  'tip.show.lead': g('One tip at a time: wall, door, Save file. Turn it off for a class that already has it.', {
    es: 'Un consejo a la vez: muro, puerta, Guardar archivo. Apágalos cuando la clase ya sepa.',
    cu: 'Un consejo a la vez: pared, puerta, Guardar archivo. Apágalos cuando la clase ya sepa.',
    uk: 'Одна підказка за раз: стіна, двері, Зберегти файл. Вимкни, коли клас уже вміє.',
    ru: 'Одна подсказка за раз: стена, дверь, Сохранить файл. Выключи, когда класс уже умеет.',
    ti: 'ሓንቲ ምኽሪ ኣብ ሓደ ግዜ፦ መንደቕ፣ ማዕጾ፣ Save file።',
    fa: 'هر بار یک راهنما: دیوار، در، ذخیره فایل. برای کلاسی که بلد است خاموشش کن.',
  }),

  /* TA assist — CURRICULUM-ONBOARD-UDL-ELL-NEURO.md. Teacher/aide setting, or
     ?ta=1 on a cart set up before class. Never labels the student. */
  'tip.ta': g('TA assist', {
    es: 'Apoyo del asistente', cu: 'Apoyo del asistente', uk: 'Режим асистента', ru: 'Режим ассистента', ti: 'ሓገዝ ሓጋዚ', fa: 'حالت دستیار',
  }),
  'tip.ta.lead': g('For a 1:1 aide. Tips stay on with a Next tip button, taps get fatter, Teach and the long Help stay folded.', {
    es: 'Para un asistente 1:1. Los consejos siguen con un botón Siguiente consejo, los toques crecen, Enseñar y la ayuda larga quedan plegadas.',
    cu: 'Para un asistente 1:1. Los consejos siguen con un botón Siguiente consejo, los toques crecen, Enseñar y la ayuda larga quedan plegadas.',
    uk: 'Для асистента 1:1. Підказки лишаються з кнопкою Наступна підказка, натиски більші, Навчання й довга довідка згорнуті.',
    ru: 'Для ассистента 1:1. Подсказки остаются с кнопкой Следующая подсказка, нажатия больше, Уроки и длинная справка свёрнуты.',
    ti: 'ን1:1 ሓጋዚ። ምኽርታት ይጸንሑ፣ ጠውቕታት ይዓብዩ፣ ምምሃርን ነዊሕ ሓገዝን ተዓጻጺፎም ይጸንሑ።',
    fa: 'برای دستیار یک‌به‌یک. راهنما با دکمهٔ راهنمای بعدی می‌ماند، ضربه‌ها درشت‌تر، آموزش و راهنمای بلند تا می‌شوند.',
  }),
  'tip.ta.label': g('TA can tap for student', {
    es: 'El asistente puede tocar por el estudiante',
    cu: 'El asistente puede tocar por el estudiante',
    uk: 'Асистент може натискати замість учня',
    ru: 'Ассистент может нажимать за ученика',
    ti: 'ሓጋዚ ኣብ ክንዲ እቲ ተመሃራይ ክጠውቕ ይኽእል',
    fa: 'دستیار می‌تواند به‌جای دانش‌آموز بزند',
  }),
  'tip.whisper.kicker': g('For the TA', {
    es: 'Para el asistente', cu: 'Para el asistente', uk: 'Для асистента', ru: 'Для ассистента', ti: 'ንሓጋዚ', fa: 'برای دستیار',
  }),
  'tip.whisper.welcome': g('Point to a big house card. Let them choose.', {
    es: 'Señala una tarjeta de casa grande. Deja que elija.',
    cu: 'Señala una tarjeta de casa grande. Deja que elija.',
    uk: 'Покажи на велику картку будинку. Хай обере сам.',
    ru: 'Покажи на большую карточку дома. Пусть выберет сам.',
    ti: 'ናብ ዓባይ ካርድ ገዛ ኣመልክት። ንሱ ይምረጽ።',
    fa: 'به یک کارت بزرگ خانه اشاره کن. بگذار خودش انتخاب کند.',
  }),
  'tip.whisper.wall': g('Hand-over-hand OK. Two clicks only.', {
    es: 'Mano sobre mano está bien. Solo dos clics.',
    cu: 'Mano sobre mano está bien. Solo dos toques.',
    uk: 'Рука в руці — можна. Тільки два кліки.',
    ru: 'Рука в руке — можно. Только два клика.',
    ti: 'ኢድ ኣብ ልዕሊ ኢድ ይፍቀድ። ክልተ ጠውቕታት ጥራይ።',
    fa: 'دست‌روی‌دست اشکالی ندارد. فقط دو کلیک.',
  }),
  'tip.whisper.door': g('Guide finger to the wall line.', {
    es: 'Guía el dedo hasta la línea del muro.',
    cu: 'Guía el dedo hasta la línea de la pared.',
    uk: 'Підведи палець до лінії стіни.',
    ru: 'Подведи палец к линии стены.',
    ti: 'ኣጻብዕቲ ናብ መስመር መንደቕ መርሕ።',
    fa: 'انگشت را روی خط دیوار ببر.',
  }),
  'tip.whisper.save': g('Celebrate the file. That’s the turn-in.', {
    es: 'Celebra el archivo. Eso es la entrega.',
    cu: 'Celebra el archivo. Eso es la entrega.',
    uk: 'Порадій файлу. Це і є здача роботи.',
    ru: 'Порадуйся файлу. Это и есть сдача работы.',
    ti: 'ነቲ ፋይል ኣብዕሎ። እዚ እዩ እቲ ምርካብ።',
    fa: 'فایل را جشن بگیر. همین تحویل کار است.',
  }),
  'tip.help.more': g('More help', {
    es: 'Más ayuda', cu: 'Más ayuda', uk: 'Більше довідки', ru: 'Больше справки', ti: 'ተወሳኺ ሓገዝ', fa: 'راهنمای بیشتر',
  }),
