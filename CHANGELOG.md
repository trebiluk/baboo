...
## 1.0.21 — 2026-09-07
- Crowd test: scatter 80 / 250 / 800 pieces and watch the FPS chip
- Plan stays snappy: one grid draw, labels hide when the plan is packed

## 1.0.20 — 2026-09-07
- Baboo talks like a studio pal: warmer welcome, cheer-you-on coach, kinder toasts

## 1.0.19 — 2026-09-07
- Skill levels: Novice, Beginner, Moderate, Expert

## 1.0.18 — 2026-09-07
- Floating Tools chip on the left and Teach chip on the right

## 1.0.17 — 2026-09-07
- Room tool: name enclosed spaces from closed walls

## 1.0.11 — 2026-09-06
- guiTheme fallbacks coerced to stark

## 1.0.10 — 2026-09-06
- Tools-ease UDL, 3D view-only chrome, Teacher gated behind long-press version / `?teacher=1`

## 1.0.0 — 2026-09-06
- Local MVP: 2D plan, IndexedDB, `.archworks.json`, Teacher debug drawer
